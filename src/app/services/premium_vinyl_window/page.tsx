...
const page = {
  ...
  description:
    ...
    "The true substance is the quality and expertise built into every step of the design and manufacturing process. " +
    "Choosing Integrity Siding And Window for your new windows, you can rest assured that every window is measured, " +
    "custom-made, and installed to fit your windows precisely. We take pride in Alside's exceptional 'custom-crafted' " +
    "made in America quality. Our MEZZO windows are all ENERGY STAR certified, meaning they are a positive choice for energy " +
    "efficiency, fuel savings, and the environment. Dual-paned, double-strength insulated glass with energy-engineered frame " +
    "and sash and low-conductive composite reinforcements.",
  ...
  types: [
    ...
    },
    {
      ...
      description:
        ...
        "open gently outward on a state-of-the-art hinge system, providing multi-directional ventilation and easy cleaning " +
    ...
    },
    {
      ...
      description:
        "Transform your room with these stunning windows that really bring out the character you want in your home! Be it " +
        "a cozy reading nook, a striking focal point, or a bright display of your prized plants and flowers. Available in a " +
